		...
		<ul id="side-nav" class="main-menu navbar-collapse collapse">
			...
			<li class="has-sub"><a href="introduce.php"><i class="icon-layout"></i><span class="title">Ký Túc Xá</span></a>
				<ul class="nav collapse">
					<li><a href="introduce.php"><span class="title">Giới Thiệu</span></a></li>
		...
		<div class="main-header row">
		  ...
		  <div class="col-sm-6 col-xs-5 height-header1">
			...
			<ul class="user-info pull-left">          
			  ...
			  <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> <img width="44" class="img-circle avatar" alt="" src="images/nu.jpg"><?php 
