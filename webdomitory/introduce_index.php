  ...
  <div class="main-container gray-bg">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb breadcrumb-2"> 
				...
				<li>Ký túc xá</li> 
				<li class="active"><strong>Giới thiệu</strong></li> 
			</ol>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading no-border clearfix" style="background: #58FAF4;"> 
							<h2 class="panel-title"><b>GIỚI THIỆU KÝ TÚC XÁ</b></h2>
						</div> 
						<!-- panel body --> 
							...
							<div class="col-lg-10">
								...
								<div class="card">
									...
									<div class="card-content">
										<p> Kí túc xá Đại học Bách khoa- Đại học Đà Nẵng được tọa lạc tại số 60 Ngô Sỹ Liên, phường Hòa Khánh Bắc, quận Liên Chiểu, TP. Đà Nẵng, xây dựng năm 1977 bên cạnh Trường Đại học Bách khoa - Đại học Đà Nẵng.

			 							<br><br>Tính tới thời điểm hiện tại gồm 5 Khu nhà, giải quyết chỗ ở cho hơn 1200 sinh viên. Trong đó có một Khu nhà giành riêng cho các du học sinh.

										<br><br>Với tiêu chí không những tạo chỗ ở mà còn đáp ưng các nhu cầu vui chơi, giải trí cũng như học tập của sinh viên. Kí túc xá Đại học Bách khoa - Đại học Đà Nẵng ngày càng chú trọng hơn về quang cảnh cũng như cơ sở vật chất. Về cơ sở vật chất, ngoài phòng ở, mỗi khu nhà có riêng phòng tự học cho sinh viên, phủ mạng khắp ký túc. Bên cạnh đó, nhằm đáp ứng nhu cầu giải trí lành mạnh ở sinh viên, kí túc xá không ngừng xây dựng các khu thể dục thể thao: sân bóng đá, bóng chuyền, cầu lông…. Số lượng cây xanh và ghế đá cũng tăng lên đáng kể, tạo không gian mát mẻ, trong lành cho sinh viên.</p>

										<img src="images/1.jpg">

										<p>Để thúc đẩy hoạt động an ninh cũng như phòng trào, Đội Tự Quản được thành lập để đại diện cho sinh viên. Nhờ đó, nhiều hoạt động đã được tổ chức thường xuyên cho sinh viên trong và ngoài ký túc: Hội xuân ký túc xá, giải bóng đá, hội thi nấu ăn…... Tạo thêm sân chơi cũng như giúp cho ký túc ngày càng được biết đến rộng rãi.</p>

										<img src="images/3.png">

										<p>Như vậy, với vị trí thuân lợi, môi trường sống phù hợp, sự quan tâm nhiệt tình từ Ban Quản Lý và đại diện sinh viên. Ký túc xá Đại học Bách khoa, Đại học Đà Nẵng ngày càng được nhiều sinh viên xa nhà lựa chọn.

										<br><br>Hy vọng quý vị và các bạn sẽ có những ngày tháng sống vui vẻ, thoả mái trong KTX Bách khoa, chúc quý vị và các bạn hạnh phúc và đạt được nhiều thành quả tốt đẹp trong công tác, học tập.</p>
									</div>
									<!-- /card content -->			
								</div>
								<!-- /card -->
